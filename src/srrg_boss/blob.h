...
#define BOSS_REGISTER_BLOB(class_name) \
  static srrg_boss::AutoRegisterer<srrg_boss::BLOBReference<class_name > > _reg_##class_name(#class_name,typeid(srrg_boss::BLOBReference<class_name >).name());
